...
public class Signer : AndroidBotSignProvider, IDisposable
{
    ...
    [
        ...
        "trpc.passwd.manager.PasswdManager.SetPasswd", "trpc.qqva.vipdata.Vipdata.SsoGetUserData", "OidbSvc.0x8a1_0",
        "OidbSvcTrpcTcp.0x101e_2", "OidbSvcTrpcTcp.0xf67_1", "trpc.qpay.sso.web.Do", "OidbSvcTrpcTcp.0xf6e_1",
        "OidbSvcTcp.0x102a", "trpc.o3.ecdh_access.EcdhAccess.SsoSecureA2Access", "OidbSvcTrpcTcp.0x88d_0",
        "OidbSvcTrpcTcp.0x1258_1", "OidbSvcTrpcTcp.0x11ec_1", "OidbSvcTrpcTcp.0x899_9",
        ...
        "qidianservice.135", "OidbSvc.0x5eb_96", "OidbSvc.0x592_5", "trpc.group_pro.msgproxy.sendmsg", "oidb_0x43c_4",
        "OidbSvc.0x787_0", "ConnAuthSvr.get_app_info_emp", "OidbSvc.0xb3c_1", "QQStranger.login_svr.SsoLoginInfoReport",
        ...
        "trpc.springfestival.redpacket.LuckyBag.SsoSubmitGrade", "OidbSvc.0xb3c_6", "OidbSvc.0x89b_1", "wtlogin.login",
        "OidbSvcTrpcTcp.0x7c2_5", "oidb_0xcf3_0", "gcbindgroupsso.get_appid", "SQQzoneSvc.getVisitorNotify",
        "qidianservice.290", "trpc.qlive.word_svr.WordSvr.NewPublicChat", "wtlogin.register", "OidbSvcTrpcTcp.0xf57_9",
        "friendlist.GetMultiTroopInfoReq", "StatSvc.GetOnlineStatus", "OidbSvcTrpcTcp.0x10db_1", "OidbSvc.0x9fa",
        "OidbSvcTrpcTcp.0xe37_800", "qidianservice.269",
        ...
        "OidbSvc.0x592_3", "OidbSvcTrpcTcp.0xf55_1", "WalletGestureSvc.SetPassword", "friendlist.GetTroopMemberList",
        "OidbSvcTrpcTcp.0xfd4_1", "OidbSvcTrpcTcp.0xfa5_1", "OidbSvcTrpcTcp.0x787_1",
        "trpc.qpay.encryptedtransfer.Encryption.SsoUINEncrypt", "oidb_0xeb1_1", "gcbindgroupsso.unbind_group",
        "oidb_0xdc2_34", "trpc.qlive.qlive_proxy_svr.TrpcProxy.*", "OidbSvc.0x592_4", "OidbSvcTrpcTcp.0xfe1_2",
        "SQQzoneSvc.publishmood", "trpc.down.intercept.Intercept.SsoGetDownloadTips",
        "LightAppSvc.mini_app_cloudstorage.GetUserCloudStorage",
        "trpc.down.joint_operation_game_intercept.JointOperationGameIntercept.SsoQueryConfig", "GDCTrpcProxy.service",
        "SQQzoneSvc.forward", "OidbSvc.0x5eb_cn_switch", "OidbSvcTrpcTcp.0x930d_0", "OidbSvc.0x6d7_0",
        "OidbSvcTrpcTcp.0xcd5", "trpc.o3.ecdh_access.EcdhAccess.SsoSecureA2Establish", "OidbSvcTrpcTcp.0x102a_1",
        "OidbSvcTrpcTcp.0x89a_0", "trpc.msg.register_proxy.RegisterProxy.PushParams",
        ...
        "oidb_0x7c4_0", "OidbSvcTrpcTcp.0xfe5_2", "oidb_0x7a2_0", "oidb_0x42e_3", "friendlist.GetTroopAppointRemarkReq",
        "trpc.lplan.map_svr.Map.SsoReportLocation", "OidbSvcTrpcTcp.0x125b_500", "friendlist.GetLastLoginInfoReq",
        "friendlist.GetFriendListReq", "oidb_0xe37_1200", "OidbSvcTrpcTcp.0x9124_0", "VisitorSvc.ReqFavorite",
        "SQQzoneSvc.get_all_feedsphoto_ex", "StatSvc.register", "SQQzoneSvc.getPhotoComment", "oidb_0x7df_3",
        "SQQzoneSvc.getActiveFeeds", "SQQzoneSvc.preGetPassiveFeeds", "SQQzoneSvc.getAIONewestFeeds",
        "ResourceConfig.ClientReq", "friendlist.getFriendGroupList", "SQQzoneSvc.photo", "OidbSvc.0xc33_42220",
        ...
        "OidbSvc.0x5eb_99", "OidbSvcTrpcTcp.0x899_0", "OidbSvc.0x6d9_4", "OidbSvc.0x787_1", "OidbSvcTrpcTcp.0x88d_111",
        "friendlist.addFriend", "OidbSvcTrpcTcp.0x6d9_2", "OidbSvcTrpcTcp.0x6d6_3", "OidbSvcTrpcTcp.0x127a_0",
        "oidb_0xe61_1", "OidbSvc.0x88d_1_2", "OidbSvc.0x592_1", "OidbSvcTrpcTcp.0x126e_200",
        "FeedCloudSvr.trpc.feedcloud.commreader.ComReader.GetFeedList", "OidbSvc.0xe61", "OidbSvcTrpcTcp.0x6d6_2",
        "OidbSvc.0x53c_2", "SQQzoneSvc.shuoshuo", "OidbSvcTrpcTcp.0x126d_200", "OidbSvcTrpcTcp.0x1225_0",
        "OidbSvcTrpcTcp.0x11e9_200", "OidbSvc.0x852_48", "OidbSvc.0xbcb", "OidbSvc.0x42d", "OidbSvc.0x515_2",
        "OidbSvcTrpcTcp.0x11c5_200", "OidbSvcTrpcTcp.0x11c4_200", "trpc.qqhb.qqhb_proxy.Handler.sso_handle",
        "OidbSvcTrpcTcp.0x11c4_100", "OidbSvc.0x852_35", "OidbSvcTrpcTcp.0x1194_1", "OidbSvcTrpcTcp.0x10c0_1",
        "OidbSvc.0x88d_7", "OidbSvcTrpcTcp.0x110d_1", "OidbSvcTrpcTcp.0x10f4_1", "friendlist.AddFriendReq",
        "OidbSvcTrpcTcp.0xfe1", "OidbSvcTrpcTcp.0x902e_1", "OidbSvcTrpcTcp.0x10c0_2", "QSec.AVEng",
        "SecuritySvc.GetConfig", "FeedCloudSvr.trpc.feedcloud.commwriter.ComWriter.DoFollow",
        "group_member_card.get_group_member_card_info", "OidbSvc.0x570_8", "OidbSvc.0xe63_1", "OidbSvcTrpcTcp.0x8f9_14",
        "OidbSvc.0x7df_3", "FeedCloudSvr.trpc.feedcloud.commreader.ComReader.GetReplyList", "OidbSvc.0x58b",
        "OidbSvcTrpcTcp.0x9a2_12", "OidbSvcTrpcTcp.0xfe7_2", "OidbSvc.0xe3e", "OidbSvc.0x592_16",
        ...
        "OidbSvcTrpcTcp.0x644_1", "oidb_0x43c_5", "OidbSvc.0xbe8", "OidbSvcTrpcTcp.0xfe1_8", "OidbSvcTrpcTcp.0x101e_1",
        "OidbSvc.0x5d0_1", "OidbSvc.0x8a1_7", "MessageSvc.PbGetRoamMsg", "oidb_0xe8c_0", "OidbSvcTrpcTcp.0x10d8_1",
        "OidbSvc.0x8a0_0", "OidbSvcTrpcTcp.0xe37_700", "OidbSvc.0x587_normalNightSet", "OidbSvc.0x899_9",
        "OidbSvc.0x587_123", "QQRTCSvc.RoomManager-GetRoomInfo", "friendlist.GetTroopListReqV2", "OidbSvc.0x592_13",
        "MessageSvc.PbSendMsg", "wtlogin.qrlogin", "oidb_0x9072_0", "OidbSvc.0x592_9", "OidbSvcTrpcTcp.0x11ea_200",
        "FeedCloudSvr.trpc.feedcloud.commwriter.ComWriter.PublishFeed", "OidbSvc.0x7a2_0", "OidbSvc.0x8a4",
        "OidbSvc.0x88d_1", "oidb_0x5d6_21", "oidb_0x5d6_19", "OidbSvc.0x8f1", "OidbSvcTrpcTcp.0x11e9_100",
        "OidbSvcTrpcTcp.0x1017_1", "OidbSvc.0xb3c_3", "trpc.qpay.midas_order.Order.SsoMakeOrder",
        "OidbSvcTrpcTcp.0x116c_1", "OidbSvc.0x5eb_ForTheme", "SQQzoneSvc.getPhotoWall", "OidbSvc.0x5eb_22",
        "OidbSvc.0x5eb_42073", "ConnAuthSvr.sdk_auth_api_emp",
        ...
        "friendlist.GetSimpleOnlineFriendInfoReq", "OidbSvc.0xbbb", "OidbSvcTrpcTcp.0x1130_1", "OidbSvc_device.0x633",
        "FeedCloudSvr.trpc.feedcloud.commreader.ComReader.GetRerankedFeedList", "SQQzoneSvc.getProfile",
        "QQConnectLogin.pre_auth_emp", "OidbSvc.0xcdd", "MessageSvc.PbBindUinGetMsg", "OidbSvc.0x480_9",
        "AvatarInfoSvr.QQHeadUrlReq", "OidbSvc.0x480_9_IMCore", "OidbSvcTrpcTcp.0x10c8_1", "OidbSvcTcp.0x88d_1",
        "OidbSvcTrpcTcp.0x1289_1", "LightAppSvc.mini_app_privacy.GetPrivacyInfo",
    ...
    {
        var protocol = Context.Config.Protocol;
